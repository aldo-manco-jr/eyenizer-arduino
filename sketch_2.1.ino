/*
 * Eyenizer 2.1 - Aldo & Eduardo Manco
...
// Stampa Istruzioni & Orario in Tempo Reale

void realTime(){
  // Pulisci Schermo Per Ogni Aggiornamento dei Secondi
  lcd.clear();
  // Stampa Istruzione
...
void employee(int minute, int hour, int dayOfWeek, int dayOfMonth, int month, int year){
    ...
    lcd.clear();
    // Mette in Attesa Per Mezzo Secondo Per Dare il Tempo di Scrivere i Dati sulla SD
    lcd.print("Attendere...");
    delay(500);
    // Cancella "Attendere..."
    lcd.clear();
    // Riscrivi Istruzioni su LCD con Mezzo Secondo di Ritardo
    delay(500);
}
...
void setup() 
{
  ...
  // Stampa Istruzioni & Orario in Tempo Reale all'Avvio
  realTime();
}
